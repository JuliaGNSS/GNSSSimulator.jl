@testset "Jammer" begin
    ...
    gnss_system = GNSSSignals.GPSL1()
    jammer = GNSSSimulator.CWJammer(1, CartesianFromSpherical()(Spherical(0.0, 0.0, 1.0)), 0.0m / 1s, jammer_power)
    ...
    @test signal ≈ cis.(2π * interm_freq / sample_freq * (1:100)) * uconvertrp(NoUnits, jammer_power)
end