@testset "DOAs" begin
    ...
    @testset "Dynamic DOAs" begin
        ...
        dynamic_doa = DynamicDOA(doas, 0.0s, 1.0Hz)
        next_dynamic_doa = propagate(dynamic_doa, 1s)
        ...
        linear_dynamic_doa = LinearDynamicDOA(Spherical(1.0, 0.0, 0.0), 0.1rad/s, 0.0rad/s)
        next_linear_dynamic_doa = propagate(linear_dynamic_doa, 1s)
